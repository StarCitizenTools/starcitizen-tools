...
class DomNavigatorTest extends \MediaWikiTestCase {
	...
	public function testFindElementsWithClass() {
		...
		$navigator = new DomNavigator(
			'<div><span x="1"></span><span class="foo" x="2">' .
	...
	public function testFindElementsWithClassPrefix() {
		// one class
		$navigator = new DomNavigator(
			'<div><span class="foo">1</span><span class="foobar">2</span>' .
		...
		// more classes
		$navigator = new DomNavigator(
			'<div><span class="baz foobar boom">1</span><span class="foobar baz">2</span>' .
		...
		$navigator = new DomNavigator(
			'<div><span class="baz barfoo boom">1</span><span class="fo obar baz">2</span>' .
	...
	public function testMultipleElementNames() {
		$navigator = new DomNavigator(
			'<div><span class="foo">1</span><div class="foo">2</div>' .
	...
	public function testFindElementsWithClassAndLang() {
		$navigator = new DomNavigator(
			'<div><span lang="en">1</span><span class="foo">2</span>' .
	...
	public function testFindElementsWithIdPrefix() {
		$navigator = new DomNavigator(
			'<div><span id="foo">1</span><span id="foobar">2</span>' .
	...
	public function testClosest() {
		$navigator = new DomNavigator(
			'<span><ul id="a"><li id="b"><span id="c"><b></b></span></li></ul></span>' );
