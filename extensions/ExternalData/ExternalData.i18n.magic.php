...
/** English (English) */
$magicWords['en'] = [
	'get_web_data' => [ 0, 'get_web_data' ],
	'get_file_data' => [ 0, 'get_file_data' ],
...
/** Arabic (العربية) */
$magicWords['ar'] = [
	'get_web_data' => [ 0, 'عرض_بيانات_الويب' ],
	'get_file_data' => [ 0, 'عرض_بيانات_الملف' ],
	'get_soap_data' => [ 0, 'عرض_بيانات_السوب' ],
	'get_ldap_data' => [ 0, 'عرض_بيانات_لداب' ],
	'get_db_data' => [ 0, 'عرض_بيانات_قب' ],
...
/** Chechen (нохчийн) */
$magicWords['ce'] = [
	'get_ldap_data' => [ 0, 'схьаэца_хаамаш_ldap', 'получить_данные_ldap' ],
	'get_db_data' => [ 0, 'схьаэца_хаамаш_db', 'получить_данные_db' ],
	'external_value' => [ 0, 'архьара_дозалла', 'внешнее_значение' ],
	'for_external_table' => [ 0, 'оцу_архьара_тебалецlаш', 'для_внешней_таблицы' ],
];

/** German (Deutsch) */
$magicWords['de'] = [
	'get_web_data' => [ 0, 'hole_webdaten' ],
	'get_ldap_data' => [ 0, 'hole_ldapdaten' ],
	'get_db_data' => [ 0, 'hole_dbdaten' ],
...
/** Greek (Ελληνικά) */
$magicWords['el'] = [
	'get_web_data' => [ 0, 'λήψη_δεδομένων_ιστού' ],
	'get_ldap_data' => [ 0, 'λήψη_δεδομένων_ldap' ],
	'get_db_data' => [ 0, 'λήψη_δεδομένων_βδ' ],
...
/** Spanish (español) */
$magicWords['es'] = [
	'get_db_data' => [ 0, 'obtener_datos_db' ],
	'external_value' => [ 0, 'valor_externo' ],
];

/** Persian (فارسی) */
$magicWords['fa'] = [
	'get_web_data' => [ 0, 'گرفتن_داده_وب' ],
];

/** Western Frisian (Frysk) */
$magicWords['fy'] = [
	'external_value' => [ 0, 'eksterne_wearde' ],
];

/** Japanese (日本語) */
$magicWords['ja'] = [
	'get_ldap_data' => [ 0, 'ldapデータ取得' ],
...
/** Korean (한국어) */
$magicWords['ko'] = [
	'get_web_data' => [ 0, '웹_데이터_얻기' ],
	'get_file_data' => [ 0, '파일_데이터_얻기' ],
	'get_soap_data' => [ 0, 'soap_데이터_얻기' ],
	'get_ldap_data' => [ 0, 'ldap_데이터_얻기' ],
	'get_db_data' => [ 0, 'db_데이터_얻기' ],
...
$magicWords['mk'] = [
	'get_web_data' => [ 0, 'преземи_семрежни_податоци' ],
	'get_file_data' => [ 0, 'преземи_податотечни_податоци' ],
	'get_soap_data' => [ 0, 'преземи_soap_податоци' ],
	'get_ldap_data' => [ 0, 'преземи_ldap_податоци' ],
	'get_db_data' => [ 0, 'преземи_db_податоци' ],
...
/** Malayalam (മലയാളം) */
$magicWords['ml'] = [
	'get_web_data' => [ 0, 'വെബ്_വിവരങ്ങൾ_എടുക്കുക' ],
	'external_value' => [ 0, 'ബാഹ്യ_മൂല്യം' ],
];

/** Marathi (मराठी) */
$magicWords['mr'] = [
	'get_ldap_data' => [ 0, 'मिळवा__एलडॅप_विदा' ],
...
$magicWords['nds-nl'] = [
	...
	'get_ldap_data' => [ 0, 'ldap-gegevens_ophaolen' ],
...
/** Dutch (Nederlands) */
$magicWords['nl'] = [
	'get_web_data' => [ 0, 'webgegevens_ophalen' ],
	'get_file_data' => [ 0, 'bestandsgegevens_ophalen' ],
	'get_soap_data' => [ 0, 'soapgegevens_ophalen' ],
	'get_ldap_data' => [ 0, 'ldap_gegevens_ophalen' ],
	'get_db_data' => [ 0, 'db_gegevens_ophalen' ],
...
$magicWords['sr-ec'] = [
	'get_web_data' => [ 0, 'добави_веб_податке' ],
	'get_ldap_data' => [ 0, 'добави_лдап_податке' ],
...
$magicWords['sr-el'] = [
	'get_web_data' => [ 0, 'dobavi_mrežne_podatke' ],
	'get_ldap_data' => [ 0, 'dobavi_ldap_podatke' ],
...
$magicWords['uk'] = [
	'get_ldap_data' => [ 0, 'отримати_дані_ldap' ],
...
$magicWords['zh-hans'] = [
	'get_web_data' => [ 0, '获取网络数据' ],
	'get_file_data' => [ 0, '获取文件数据' ],
	'get_soap_data' => [ 0, '获取soap数据' ],
	'get_ldap_data' => [ 0, '获取ldap数据' ],
	'get_db_data' => [ 0, '获取数据库数据' ],
...
$magicWords['zh-hant'] = [
	'get_web_data' => [ 0, '取得網路數據' ],
	'get_file_data' => [ 0, '取得檔案數據' ],
	'get_soap_data' => [ 0, '取得soap數據' ],
	'get_ldap_data' => [ 0, '取得ldap數據' ],
